...
let data: any = {
  defaultData: {
    ...
    OrderDetails: [
      { orderNumber: 1, line: 1, product: 1, price: 0.37, quantity: 1, id: 87 },
      { orderNumber: 2, line: 2, product: 2, price: 0.43, quantity: 2, id: 72 },
      { orderNumber: 3, line: 3, product: 3, price: 0.03, quantity: 3, id: 0 },
      { orderNumber: 4, line: 4, product: 4, price: 0.04, quantity: 4, id: 40 },
      { orderNumber: 5, line: 5, product: 5, price: 0.88, quantity: 5, id: 27 },
    ],
    Payments: [
      {
        orderNumber: 1,
